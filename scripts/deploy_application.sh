...
helm upgrade --install customers-db bitnami/mysql --namespace spring-petclinic -f k8s/1-application/mysql-values.yaml --set fullnameOverride=customers-db
...
kubectl apply -f k8s/1-application/customers-service/

# ==========================================
# DOMINIO VETS
# ==========================================
echo "4. Desplegando dominio VETS..."
helm upgrade --install vets-db bitnami/mysql --namespace spring-petclinic -f k8s/1-application/mysql-values.yaml --set fullnameOverride=vets-db
...
kubectl apply -f k8s/1-application/vets-service/

# ==========================================
# DOMINIO VISITS
# ==========================================
echo "5. Desplegando dominio VISITS..."
helm upgrade --install visits-db bitnami/mysql --namespace spring-petclinic -f k8s/1-application/mysql-values.yaml --set fullnameOverride=visits-db
...
kubectl apply -f k8s/1-application/visits-service/
